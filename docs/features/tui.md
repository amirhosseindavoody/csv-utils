...
| `column_pinned` | Per-column flag: pinned to the left of the table (always visible when not hidden; horizontal scroll applies only to unpinned columns) |
...
| Column list **right-click** | Open context menu: **Hide** / **Unhide**, **Info**, **Pin** / **Unpin** |
